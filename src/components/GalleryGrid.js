  ...
  return (
    <>
      <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
        {items.map((item) => (
          <div key={item._id} className="break-inside-avoid group overflow-hidden rounded-2xl bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] shadow-2xl transition-all hover:-translate-y-2 relative">
            <div className="overflow-hidden relative cursor-pointer" onClick={() => openFullscreen(item)}>
              <img 
                src={item.image} 
